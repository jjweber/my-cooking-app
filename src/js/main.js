...
function openAddModal(index) {
  ...
  <form id="addRecipeForm">
      ...
      <input type="text" class="form-control" name="PhotoUrl" placeholder="e.g. Homemade Cobbler..." required pattern="[a-zA-Z]+" minlength="3">
    
      <label for="Title">Recipe Name:</label>
      <input type="text" class="form-control" name="Title" placeholder="e.g. Homemade Cobbler..." required pattern="[a-zA-Z]+" minlength="3">
    
      <label for="Description">Recipe Description:</label>
      <textarea class="form-control" rows="3" name="Description" placeholder="e.g. Best Cobbler I have ever tasted..." required minlength="3"></textarea>
  ...
  <div id="addModalBtns">
    <input id="addReciepeSaveBtn" class="btn btn-success" type="button" value="Save">
...
function openEditModal(index) {
    ...
    <form id="editRecipeForm">
      ...
      <label for="PhotoUrl">Recipe Image:</label>
      <input type="text" class="form-control" name="PhotoUrl" value=" ${currentRecipe.PhotoUrl} " />

      <label for="Title">Recipe Name:</label>
      <input type="text" class="form-control" name="Title" value=" ${currentRecipe.Title} " required pattern="[a-zA-Z]+" minlength="3" />

      <label for="Description">Recipe Description:</label>
      <textarea class="form-control" rows="3" name="Description" required minlength="3">${currentRecipe.Description}</textarea>
    ...
    <div id="editModalBtns">
      <input id="editModalSaveBtn" class="btn btn-success" type="button" value="Save">
...
/**********************************************************/
/*************** Plugin Notification Javascript**************/
/**********************************************************/
